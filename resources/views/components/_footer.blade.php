    ...
    <div class="footer-grid" style="justify-content:center; text-align:center;">
      <div class="footer-col">
        <div class="footer-social">
          ...
          <a href="{{ $socialLinks['linkedin'] ?? '#' }}" aria-label="لينكد إن" title="لينكد إن" target="_blank" rel="noopener" style="{{ !empty($socialLinks['linkedin']) ? '' : 'opacity:.5; pointer-events:none' }}"><i class="bi bi-linkedin"></i></a>
