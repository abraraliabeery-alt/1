...
@section('content')
@php($properties = ($properties ?? collect()))
  ...
  <div class="about-band p-4 p-md-5">
    <div class="row g-4 align-items-center">
      <div class="col-lg-6 order-2 order-lg-1">
        ...
        <h2 class="mt-3 fw-bolder" style="color:var(--ink)">شركة مدى الذهبية</h2>
        <p class="text-muted lh-lg m-0">منصة عربية لإدارة وبيع وتأجير العقارات تركّز على تجربة استخدام بسيطة وأداء سريع ونتائج بحث دقيقة.
        </p>
        <ul class="check-list mt-3">
          <li><i class='bx bxs-check-circle'></i> عروض فاخرة محدثة يوميًا</li>
          <li><i class='bx bxs-check-circle'></i> فلترة ذكية ونتائج دقيقة</li>
          <li><i class='bx bxs-check-circle'></i> دعم كامل لـ RTL والعربية</li>
        </ul>
        ...
        <div class="row g-3 mt-4 text-center">
          <div class="col-4">
            ...
            <div class="text-muted small">عقار متاح</div>
          </div>
          <div class="col-4">
            <div class="fw-bolder" style="color:var(--ink)">+600</div>
            <div class="text-muted small">عميل راضٍ</div>
          </div>
          <div class="col-4">
            <div class="fw-bolder" style="color:var(--ink)">+70</div>
            <div class="text-muted small">مدينة</div>
          </div>
        </div>
      </div>
...
<section id="services" class="container py-5">
  ...
  <div class="row g-4 text-center">
    <div class="col-12 col-md-4">
      <div class="feature-box sheen h-100">
        <i class='bx bxs-building-house fs-3 mb-3'></i>
        <h5 class="fw-bolder">بيع وشراء العقارات</h5>
        <p class="text-muted m-0">نقارن العروض ونقترح الأنسب لضمان أفضل قيمة.</p>
      </div>
    </div>
    <div class="col-12 col-md-4">
      <div class="feature-box sheen h-100">
        <i class='bx bx-cog fs-3 mb-3'></i>
        <h5 class="fw-bolder">إدارة الأملاك</h5>
        <p class="text-muted m-0">تحصيل الإيجارات، الصيانة الدورية، تقارير شهرية.</p>
      </div>
    </div>
    <div class="col-12 col-md-4">
      <div class="feature-box sheen h-100">
        <i class='bx bx-analyse fs-3 mb-3'></i>
        <h5 class="fw-bolder">الاستشارات العقارية</h5>
        <p class="text-muted m-0">تحليل السوق وخطط استثمارية مدروسة بثقة.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="stats text-center">
  <div class="container">
    <div class="row g-4">
      <div class="col-6 col-md-3"><h3>+1000</h3><p>عقار متاح</p></div>
      <div class="col-6 col-md-3"><h3>+600</h3><p>عميل راضٍ</p></div>
      <div class="col-6 col-md-3"><h3>+70</h3><p>مدينة مغطاة</p></div>
      <div class="col-6 col-md-3"><h3>+12</h3><p>سنوات خبرة</p></div>
    </div>
  </div>
</section>
  ...
  <div class="row g-4">
    <div class="col-12 col-md-6">
      <div class="testimonial h-100">
        ...
        <p class="mt-3 m-0">بوابة العقار خدمتني بسرعة واحترافية عالية. وجدت فيلا أحلامي خلال يومين فقط!</p>
        <div class="d-flex align-items-center gap-2 mt-3">
          <span class="avatar bg-light rounded-circle d-inline-grid place-items-center" style="width:36px;height:36px"></span>
          <h6 class="m-0">– فهد العتيبي</h6>
        </div>
      </div>
    </div>
    <div class="col-12 col-md-6">
      <div class="testimonial h-100">
        <i class='bx bxs-quote-alt-right'></i>
        <p class="mt-3 m-0">أفضل موقع عقاري جربته. فريق الدعم متعاون جدًا.</p>
        <div class="d-flex align-items-center gap-2 mt-3">
          <span class="avatar bg-light rounded-circle d-inline-grid place-items-center" style="width:36px;height:36px"></span>
          <h6 class="m-0">– سارة المطيري</h6>
        </div>
      </div>
    </div>
  </div>
...
<section id="contact" class="contact">
  <div class="container">
    ...
    @if(session('ok'))
      <div class="card mb-3" style="border-color:#bbf7d0; background:#f0fdf4">{{ session('ok') }}</div>
    @endif
    @if ($errors->any())
      <div class="card mb-3" style="border-color:#fecaca; background:#fff7f7">
    ...
    <div class="row g-4 align-items-stretch">
      <div class="col-12 col-lg-6">
        <form method="post" action="{{ route('contact.home.store') }}" class="row g-3">
          @csrf
          <div class="col-12"><input name="name" type="text" class="form-control" placeholder="الاسم الكامل"></div>
          <div class="col-12"><input name="email" type="email" class="form-control" placeholder="البريد الإلكتروني"></div>
          <div class="col-12"><input name="phone" type="text" class="form-control" placeholder="رقم الجوال (اختياري)"></div>
          <div class="col-12"><textarea name="message" class="form-control" rows="5" placeholder="اكتب رسالتك هنا..." required>{{ old('message') }}</textarea></div>
          <div class="col-12"><button class="btn btn-ink w-100" type="submit">إرسال الرسالة</button></div>
        </form>
      </div>
      <div class="col-12 col-lg-6">
        <div class="p-3 p-md-4 rounded" style="background:var(--beige); border:1px solid rgba(15,23,42,.08)">
          <h5 class="fw-bolder mb-2" style="color:var(--ink)">مكتبنا</h5>
          <p class="text-muted m-0">الرياض، الحي المالي، شارع العليا</p>
          <div class="row g-3 mt-1">
            <div class="col-6 small text-muted">الهاتف</div>
            <div class="col-6 small text-end">+966 55 123 4567</div>
            <div class="col-6 small text-muted">البريد</div>
            <div class="col-6 small text-end">info@example.com</div>
            <div class="col-6 small text-muted">الدعم</div>
            <div class="col-6 small text-end">الأحد - الخميس 9ص - 6م</div>
          </div>
          <div class="d-flex gap-2 mt-3">
            <a href="#location" class="btn btn-outline-ink">موقعنا</a>
            <a href="https://wa.me/966000000000" target="_blank" class="btn btn-beige">واتساب</a>
          </div>
        </div>
      </div>
    </div>
...
<section id="location" class="container py-5">
  <div class="row g-4 align-items-start">
    ...
    <div class="col-12 col-lg-4 order-1 order-lg-2">
      ...
      <div class="p-3 rounded" style="background: var(--beige); color: var(--ink); border:1px solid rgba(15,23,42,.08)">
