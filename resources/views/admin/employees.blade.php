...
@section('admin')
  <div class="admin-header">
    ...
    <div class="tools">
      <form method="get" action="{{ route('admin.users.employees') }}" class="admin-search">
        ...
        <a class="btn btn-outline" href="{{ route('admin.users.employees') }}">إعادة تعيين</a>
      </form>
    </div>
  </div>
  ...
  <div class="table-responsive">
    <table class="table modern compact" style="width:100%">
      ...
      <tbody>
        ...
        @empty
          <tr>
            <td colspan="3" class="text-center text-muted">لا يوجد موظفون</td>
          </tr>
        @endforelse
      </tbody>
    </table>
