  ...
  <main>
    ...
    <section id="services" class="tpl-services section reveal">
      <div class="container center">
        ...
        <p class="narrow">حلول عقارية متكاملة تغطي التسويق والوساطة وإدارة الأملاك والتقييم والاستشارات والتطوير.</p>
    ...
    <section id="hero" class="section hero">
      <div class="container grid-2">
        <div class="hero-copy">
          <span class="eyebrow">مؤسسة طور البناء للتجارة</span>
          <h1>مجموعة متكاملة من <span class="hl">أدوات السباكة</span> و<span class="hl">أدوات البناء</span> و<span class="hl">الأدوات الصحية</span> و<span class="hl">الكهربائية</span> و<span class="hl">العدد</span></h1>
          <p>البيع بالآجل والسداد على دفعات ميسرة — منتجات عالية الجودة وموثوقة تُسهم في إنجاز المشاريع بدقة وكفاءة.</p>
          <ul>
            <li>البيع بالآجل</li>
            <li>دفعات ميسرة</li>
            <li>جودة وموثوقية</li>
          ...
          <div class="cta">
            <a class="btn btn-primary" href="#services">تعرّف على منتجاتنا</a>
      ...
      <span class="side-label">TOR AL-BINAA</span>
    </section>
    ...
    <section id="why-choose" class="section alt fade-in reveal">
      <div class="container">
        <h2><span class="title-deco">لماذا تختار مؤسسة طور البناء؟</span></h2>
        <div class="grid-4" style="display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1rem">
          ...
          <div class="card hover"><div class="body"><div class="badge">03</div><span class="icon-inline"><i class="fa-solid fa-truck-fast"></i></span><strong>توريد سريع</strong><p class="m-0">كميات مرنة وتسليم في الوقت.</p></div></div>
          <div class="card hover"><div class="body"><div class="badge">04</div><span class="icon-inline"><i class="fa-solid fa-credit-card"></i></span><strong>تقسيط ميسّر</strong><p class="m-0">البيع بالآجل وخطط سداد مرنة.</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section id="faq" class="section fade-in reveal">
      <div class="container">
        ...
        <details class="item">
          ...
          <div class="content">نعم، نوفر خطط دفع مرنة حسب نوع الخدمة والكمية بعد دراسة بسيطة لاحتياج العميل.</div>
        </details>
        <details class="item">
      ...
      <div class="container">
        <div class="nums">
          ...
          <div class="tile card glow tilt sheen"><div class="body">
            ...
            <div class="lbl">مشاريع منجزة</div>
          </div></div>
          <div class="tile card glow tilt sheen"><div class="body">
    ...
    <section id="products-carousel" class="section fade-in reveal">
      <div class="container">
        <div class="section-title" style="align-items:center">
          <h2 style="margin:0"><span class="title-deco">اكتشف منتجاتنا</span></h2>
          <div class="chips">
        ...
        <div class="pc-track" id="pc-track" style="display:flex; gap:1rem; overflow:auto; scroll-snap-type:x mandatory; padding-bottom:.5rem">
          <article class="card hover glow tilt pc-card" style="min-width:280px; scroll-snap-align:start"><div class="body"><div class="thumb"><img src="/assets/products/building.jpg" alt="معدات وأدوات البناء" loading="lazy"></div><span class="badge">HOT</span> <strong>أدوات البناء</strong><p class="m-0">مطارق، مثاقب، مجارف، أجهزة قياس...</p><a href="#contact" class="btn-link">تواصل معنا</a></div></article>
          <article class="card hover glow tilt pc-card" style="min-width:280px; scroll-snap-align:start"><div class="body"><div class="thumb"><img src="/assets/products/plumbing.jpg" alt="أدوات السباكة" loading="lazy"></div><span class="badge">NEW</span> <strong>أدوات السباكة</strong><p class="m-0">أنابيب، صمامات، محابس، وصلات...</p><a href="#contact" class="btn-link">تواصل معنا</a></div></article>
          <article class="card hover glow tilt pc-card" style="min-width:280px; scroll-snap-align:start"><div class="body"><div class="thumb"><img src="/assets/products/sanitary.jpg" alt="الأدوات الصحية" loading="lazy"></div><span class="badge">TOP</span> <strong>الأدوات الصحية</strong><p class="m-0">صنابير، مغاسل، أحواض، دشات...</p><a href="#contact" class="btn-link">تواصل معنا</a></div></article>
          <article class="card hover glow tilt pc-card" style="min-width:280px; scroll-snap-align:start"><div class="body"><div class="thumb"><img src="/assets/products/electric.jpg" alt="الأدوات الكهربائية" loading="lazy"></div><span class="badge">PRO</span> <strong>الأدوات الكهربائية</strong><p class="m-0">أسلاك، قواطع، مفاتيح، لوحات...</p><a href="#contact" class="btn-link">تواصل معنا</a></div></article>
          <article class="card hover glow tilt pc-card" style="min-width:280px; scroll-snap-align:start"><div class="body"><div class="thumb"><img src="/assets/products/tools.jpg" alt="عدد يدوية وكهربائية" loading="lazy"></div><span class="badge">SALE</span> <strong>العدد اليدوية والكهربائية</strong><p class="m-0">مفكات، مناشير، مفاتيح...</p><a href="#contact" class="btn-link">تواصل معنا</a></div></article>
          <article class="card hover glow tilt pc-card" style="min-width:280px; scroll-snap-align:start"><div class="body"><div class="thumb"><img src="/assets/products/plan.jpg" alt="البيع بالآجل" loading="lazy"></div><span class="badge">PLAN</span> <strong>البيع بالآجل</strong><p class="m-0">دفعات ميسرة وخطط مرنة.</p><a href="#contact" class="btn-link">استفسر الآن</a></div></article>
        </div>
      </div>
    </section>
    ...
    <section id="showcase-a" class="section showcase fade-in reveal">
      <div class="container wrap">
        ...
        <div class="copy">
          ...
          <div class="actions">
            <a href="#services" class="btn btn-primary sheen magnet">استكشف المنتجات</a>
            <a href="#contact" class="btn btn-ghost magnet">تواصل معنا</a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="grid-3">
          <div class="feature">
            ...
            <a href="#contact" class="btn btn-link">تواصل معنا</a>
          </div>
          <div class="feature">
            <div class="icon" aria-hidden="true" style="width:28px;height:28px;display:inline-block;vertical-align:middle;margin-inline-end:6px">
    ...
    <section id="about-brief" class="section fade-in reveal">
      <div class="container">
        <h2>عن مؤسسة طور البناء للتجارة</h2>
        <p>نحـــن في مؤسســـة طور البناء للتجـــارة نعتز بتقديم مجموعة متكاملة وشـــاملة من أدوات الســـباكة وأدوات البنـــاء والأدوات الصحيـــة والكهربائيـــة والعـــدد، التي تلبي احتياجات عملائنا المتنوعة. نسعى لتوفير منتجات عالية الجودة وموثوقة تسهم في إنجاز المشاريع بدقة وكفاءة. كما نتيح لعملائنا <strong>البيع بالآجل والسداد على دفعات ميسّرة</strong>.</p>
      </div>
    </section>
    ...
    <section id="contact-legacy" class="section contact fade-in reveal">
      <div class="container grid-2">
        <div>
          <h2><span class="title-deco">تواصل معنا</span></h2>
          <p>لنبدأ اليوم. املأ النموذج وسنعود إليك خلال 24 ساعة.</p>
          <form id="contact-form" action="{{ route('contact.home.store') }}" method="POST" novalidate>
            @csrf
            <div class="form-grid">
              <label>
                الاسم الكامل
                <input type="text" name="name" value="{{ old('name') }}" required placeholder="الاسم" minlength="2" autocomplete="name" class="@error('name') is-invalid @enderror" />
                @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
              </label>
              <label>
                رقم الجوال
                <input type="tel" name="phone" value="{{ old('phone') }}" required placeholder="05XXXXXXXX" inputmode="numeric" pattern="^0?5\d{8}$" autocomplete="tel" class="@error('phone') is-invalid @enderror" />
                @error('phone')<div class="invalid-feedback">{{ $message }}</div>@enderror
              </label>
              <label class="full">
                البريد الإلكتروني (اختياري)
                <input type="email" name="email" value="{{ old('email') }}" placeholder="name@example.com" autocomplete="email" class="@error('email') is-invalid @enderror" />
                @error('email')<div class="invalid-feedback">{{ $message }}</div>@enderror
              </label>
              <label class="full">
                نوع الخدمة
              ...
              <label class="full">
                وصف مختصر
                <textarea name="message" rows="4" placeholder="اخبرنا عن احتياجك..." maxlength="2000" class="@error('message') is-invalid @enderror">{{ old('message') }}</textarea>
                @error('message')<div class="invalid-feedback">{{ $message }}</div>@enderror
              </label>
            </div>
